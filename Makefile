...
.PHONY: images
images:
	docker build ${BUILD_ARG} --build-arg=TARGETARCH=$(GOARCH) -t $(REGISTRY)/executor:latest -f deploy/Dockerfile .
	docker build ${BUILD_ARG} --build-arg=TARGETARCH=$(GOARCH) -t $(REGISTRY)/executor:debug -f deploy/Dockerfile_debug .
	docker build ${BUILD_ARG} --build-arg=TARGETARCH=$(GOARCH) -t $(REGISTRY)/warmer:latest -f deploy/Dockerfile_warmer .
